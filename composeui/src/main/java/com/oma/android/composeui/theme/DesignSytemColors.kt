...
data class DesignSystemColor(
    ...
    val CanvasPrimary: Color = Color.Unspecified,
    val ToolbarSurface: Color = Color.Unspecified,
    ...
    companion object {
        ...
        val lightCustomColor = DesignSystemColor(
            ...
            TextAlternate = baseColor.Dugong,
            CanvasPrimary = Color.White,
